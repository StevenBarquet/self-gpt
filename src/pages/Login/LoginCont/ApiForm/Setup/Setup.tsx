		...
		<div className={style["Setup"]}>
			...
			<div className="setup-container">
				...
				<section className="setup-introduction">
					<h2>Introduction</h2>
					<p>
						Welcome to Self-GPT, your cost-effective and private chatbot
						solution. Follow these step-by-step instructions to set up your
						instance using OpenAI's API and Supabase for data storage.
					</p>
				</section>
				<section className="setup-prerequisites">
					...
					<ul>
						...
						<li>
							Basic familiarity with web applications and database management
				...
				<ol className="setup-steps">
						...
						<ol>
							...
							<li>
								...
								<ul>
									...
									<li>
										Confirm your email and complete any verification steps as
										needed.
									</li>
								</ul>
							</li>
					...
					<li>
						...
						<ol>
							...
							<li>
								Go to the API keys section and click "Create API Key" to
								generate a new key.
							</li>
							<li>
								<strong>Important:</strong> Copy the{" "}
								<code>OPEN_AI_API_KEY</code> key immediately and store it
								securely (e.g., in a password manager or secure private file).
							</li>
						</ol>
					</li>
					<li>
						...
						<p>
							Add credits to your account to cover anticipated usage. Typically,
							$10 is sufficient for 3-6 months of use, depending on your
							interactions.
						</p>
					</li>
					<li>
						...
						<ol>
							<li>
								...
								<ul>
									...
									<li>
										Enter a project name and choose your region, then wait for
							...
							<li>
								...
								<ul>
									...
									<li>
										Under the "Configuration" section, find the{" "}
										<code>SUPABASE_URL</code> and <code>SUPABASE_ANON_KEY</code>{" "}
										in the "Framework/React" connection settings.
									</li>
									<li>
										Copy both the <code>SUPABASE_URL</code> and{" "}
										<code>SUPABASE_ANON_KEY</code>. Store these credentials
										securely, as they are required for connecting your
					...
					<li>
						...
						<ol>
							<li>
								...
								<ul>
									<li>
										Within your Supabase project dashboard, click on "SQL
							...
							<li>
								...
								<ul>
									...
									<li>
										Paste it into the SQL Editor and execute the script to set
							...
							<li>
								...
								<ul>
									<li>
										...
										and enter the <code>SUPABASE_URL</code>,{" "}
										<code>SUPABASE_ANON_KEY</code> and{" "}
										<code>OPEN_AI_API_KEY</code> you stored securely in the
										previous steps.
									</li>
								</ul>
							</li>
