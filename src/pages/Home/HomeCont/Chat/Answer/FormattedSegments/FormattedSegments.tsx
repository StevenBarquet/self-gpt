...
export const StreamingAnswer = React.memo(function StreamingAnswer({ text }: { text: string }) {
...
export const LatexBlock = React.memo(function LatexBlock({ text }: { text: string }) {
