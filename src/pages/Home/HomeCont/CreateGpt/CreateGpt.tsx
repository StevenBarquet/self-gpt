...
export function CreateGpt() {
  ...
  // -----------------------RENDER
  return (
    <Frow vAlign='middle' className={style['CreateGpt']} hSpace={5}>
      ...
      <Fcol {...basicResponsive(35)}>
        <FBasicInput label='Icon' formik={formik} valueName='icon' placeholder='Valid SVG icon' />
      </Fcol>
